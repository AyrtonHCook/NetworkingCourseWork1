...
public class VoIPReceiverThread implements Runnable {
    ...
    public void run() {
        ...
        // hardcoded private to decrypte audio block
        ...
        while (running) {
            try {
                ...
                // seperates header, payload and check
                ...
                if (receivedCheck != expectedCheck) {
                    System.out.println("[VoIPReceiver] Packet failed check. Dropping."); // drop if false
                    continue;
                }

                // detect missing packets for logging only when decrption failed
